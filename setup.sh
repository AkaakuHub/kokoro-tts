...
echo ""
echo "使用方法:"
echo "1. 🌟 Swagger UIサーバー: $PYTHON_CMD swagger_tts.py"
echo "2. 開発用サーバー: $PYTHON_CMD lightweight_tts.py" 
echo "3. 本番用サーバー: $PYTHON_CMD server_prod.py"
echo "4. Swaggerテスト: $PYTHON_CMD test_swagger.py"
echo ""
