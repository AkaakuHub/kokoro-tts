...
echo ""
echo "使用方法:"
echo "1. 🌟 Swagger UIサーバー: ./run_swagger.sh"
echo "2. 開発用サーバー: ./run_lightweight.sh" 
echo "3. 本番用サーバー: ./run_production.sh"
echo "4. Swaggerテスト: ./run_test.sh"
echo "5. シンプルテスト: ./run_client_test.sh"
echo ""
echo "または仮想環境をアクティベートしてから:"
echo "source venv/bin/activate"
echo "python swagger_tts.py"
echo ""
echo "🌐 Swagger UI アクセス:"
echo "- http://localhost:8000/ (推奨)"
echo ""
echo "API エンドポイント:"
